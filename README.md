...
- `/cookies?url=<URL>&retries=<>&proxy=<>&user_agent=<>`: This endpoint returns the cookies of the website (including the Cloudflare cookies).
- `/html?url=<URL>&retries=<>&proxy=<>&user_agent=<>`: This endpoint returns the HTML content of the website.
